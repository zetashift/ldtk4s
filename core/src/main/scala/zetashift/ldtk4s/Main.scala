...
type EditorDisplayMode = "ArrayCountNoLabel" | "ArrayCountWithLabel" | "EntityTile" | "Hidden" | "LevelTile" | "NameAndValue" | "PointPath" | "PointPathLoop" | "PointStar" | "Points" | "RadiusGrid" | "RadiusPx" | "RefLinkBetweenCenters" | "RefLinkBetweenPivots" | "ValueOnly"
/**
 * Possible values: `Above`, `Center`, `Beneath`
 */
...
type EditorLinkStyle = "ArrowsLine" | "CurvedArrow" | "DashedLine" | "StraightArrow" | "ZigZag"
type TextLanguageMode = "LangC" | "LangHaxe" | "LangJS" | "LangJson" | "LangLog" | "LangLua" | "LangMarkdown" | "LangPython" | "LangRuby" | "LangXml"
/**
 * Possible values: `DiscardOldOnes`, `PreventAdding`, `MoveLastOne`
 */
...
type TileRenderMode = "Cover" | "FitInside" | "FullSizeCropped" | "FullSizeUncropped" | "NineSlice" | "Repeat" | "Stretch"
...
type Flag = "DiscardPreCsvIntGrid" | "ExportPreCsvIntGridFormat" | "IgnoreBackupSuggest" | "MultiWorlds" | "PrependIndexToLevelFileNames" | "UseMultilinesType"
/**
 * This object is not actually used by LDtk. It ONLY exists to force explicit references to
 * all types, to make sure QuickType finds them and integrate all of them. Otherwise,
 * Quicktype will drop types that are not explicitely used.
...
type ImageExportMode = "LayersAndLevels" | "None" | "OneImagePerLayer" | "OneImagePerLevel"
